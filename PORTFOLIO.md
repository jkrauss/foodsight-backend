...
```mermaid
flowchart TD
    subgraph zone_fe ["Frontend — Svelte SPA"]
        direction TB
    ...
    subgraph zone_ml ["Pipeline — CatBoost ML"]
        direction TB
    ...
    zone_be <-->|"predictions.csv"| zone_ml
    ...
    classDef ml fill:#FB5012,stroke:#300A6E,color:#FFFFFF,stroke-width:2px
